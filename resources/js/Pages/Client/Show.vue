            ...
            <div class="max-w-7xl mx-auto sm:px-6 lg:px-8 flex justify-between">
                <div class="bg-white p-4 rounded shadow w-[30%]">
                    ...
                    <div>
                        <div class="w-80 m-auto lg:mt-2 max-w-sm">
                            ...
                            <div class="grid grid-cols-4 w-72 lg:w-6/6 m-auto bg-green-50 mt-5 p-4 lg:p-4 rounded-2xl">
                            ...
                            <div class="flex justify-between mt-3 ml-3 mr-4">
                                ...
                                <PrimaryButton @click="edit()" class="bg-green-600">Edit Client</PrimaryButton>
                            </div>
                ...
                <div class="bg-white p-4 rounded shadow w-[68%]">
                    ...
                    <table class="w-full text-sm text-left text-black-500 dark:text-gray-400">
                        <thead class="text-xs text-white uppercase text-center bg-gray-50 dark:bg-green-500 dark:text-white-400">
                            <tr>
                        ...
                        <tbody v-for="cl in client.sales" :key="cl.id">
                            ...
                            <tr class="bg-green-200 hover:bg-s-50 text-center font-medium text-black  whitespace-nowrap ">
