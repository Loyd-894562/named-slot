...
<template>
    <div>
        <div class="min-h-screen bg-gray-100 " :class="themeMode === 'dark' ? 'dark-button' : 'light'">
            <span @click="toggleDarkMode" :class="themeMode === 'dark' ? 'dark-button' : 'light-button'" class="absolute top-4 right-4 h-8 w-8 bg-gray-400 rounded-full inline-flex items-center justify-center hover:bg-gray-400">
